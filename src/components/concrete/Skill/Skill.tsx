...
import LinearProgressColor, { LinearProgressColorProps } from '../../units/LinearProgressColor/LinearProgressColor';

export type SkillProps = React.ComponentProps<typeof Box> & LinearProgressColorProps & {
